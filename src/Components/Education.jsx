...
const Education = () => {
    return (
        <div>
            ...
            <div className="border-b border-transparent pb-20 lg-pb-0">
                <div>
                    <div className="w-full">
                        <div className="w-full flex flex-wrap justify-center"> {/* Flex for horizontal layout */}
                            ...
                            <div className="pl-6 text-left flex-wrap:flex mt-4 lg:mt-0"> {/* Stacks text vertically */}
                                <h2 className="text-yellow-500 font-bold text-lg lg:text-xl lg:mt-1">Georgia Institute of Technology</h2>
                                ...
                                {/* <h2 className="text-white font-bold text-sm">Minor | Industrial Design</h2> */}
                                <h2 className="text-white font-bold text-xs pb-4 lg:pb-2">August 2022 - May 2026</h2>
                            </div>
                        </div>
                        <div className="flex justify-center lg:my-4">
                        <p className="text-white w-full lg:w-1/2 text-center text-sm lg:text-m lg:px-6">I am currently in my 3rd year of pursuing a bachelors degree in Computer Science at Georgia Tech, concentrating in Artificial Intelligence and Media Technologies. 
                                    I am also pursuing a minor in industrial/product design, inspired by its relationship to UI/UX and people-driven software solutions in general.
                                    </p>
                        </div>
